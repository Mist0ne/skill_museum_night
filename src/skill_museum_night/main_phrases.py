...
more_facts = [
    {
        "text": "Больше о картине вы можете узнать на портале Культура РФ. https://museumnight.culture.ru/#quiz",
        "tts": "Больше о картине вы можете узнать на портале Культура РФ"
    },
    {
        "text": "Больше интересных фактов о картине узнайте на портале Культура РФ. https://museumnight.culture.ru/#quiz",
