...
Вместе с Культура РФ мы выбрали 53 картины русских художников, а нейросеть перерисовала их в непривычных стилях: экспрессионизм, пуантилизм и импрессионизм. Теперь полотна выглядят по-другому, и ваша задача — отгадать оригинал.

Пройдите игру и узнайте, как выиграть умную колонку со мной внутри.

Начнём играть?
""",
    "tts": """Васнецов или Серебрякова? «Девочка ^с персиками»^ или «с крынкой молока»? ^Попробуйте^ угадать! Вместе с Культура РФ мы выбрали 53 картины русских художников, а нейросеть перерисовала их в непривычных стилях. ^Экспрессионизм^, пуантилизм и импрессионизм. Теперь пол`отна выглядят по-другому, и ^ваша^ задача — отгадать оригинал. Пройдите игру и узнайте, ^как^ выиграть умную колонку со мной внутри. Начнём играть?""",
    "suggests": [
        "Начать",
...
exit_call = {
    ...
    "image_url": "https://sun1-20.userapi.com/s/v1/if2/KJA0PO59TY5FDTHEJkqwUoilJeX-r2JKPLfUrgNiuhPFzhKfTqGi8mCup5wFpUcJF3hucl3Q4dS2jRJC717r60he.jpg?size=101x131&quality=96&type=album"
}
