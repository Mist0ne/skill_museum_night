...
Вместе с «Культура.РФ» мы выбрали 32 картины художников, а нейросеть перерисовала их в непривычных стилях: экспрессионизм, пуантилизм и импрессионизм. Теперь полотна выглядят по-другому, и ваша задача — отгадать оригинал.

Пройдите игру и узнайте, как выиграть умную колонку со мной внутри.

Начнём играть?
""",
    "tts": """Васнецов или Серебрякова? «Девочка ^с персиками»^ или «с крынкой молока»? ^Попробуйте^ угадать! Вместе с Культура РФ мы выбрали 32 картины художников, а нейросеть перерисовала их в непривычных стилях. ^Экспрессионизм^, пуантилизм и импрессионизм. Теперь пол`отна выглядят по-другому, и ^ваша^ задача — отгадать оригинал. Пройдите игру и узнайте, ^как^ выиграть умную колонку со мной внутри. Начнём играть?""",
    "suggests": [
        "Начать",
...
1) Подпишитесь на нашу группу и группу «Культура.РФ» в ВКонтакте 
...
Результаты розыгрыша мы объявим 26.05 в нашей группе ВКонтакте""",
    "tts": "Мы обещали рассказать, ^как^ выиграть Капсулу Мини. ^Подпишитесь^ на нашу группу и группу Культура РФ в ВКонтакте. Выложите на стену понравившуюся нейракарт`ину. Поставьте к записи ^хэшт`ег^. Мы разыграем среди участников специальные ^призы^. Результаты розыгрыша мы объявим двадцать шестого мая в нашей группе ВКонтакте."
}
...
next_picture_synonims = [
    "показать следующую",
    "показать следующую картину",
    "показать",
    "показать новую",
    "показать новую картину",
    "покажи",
    "пойдем",
    "пошли",
    "давай пошли",
